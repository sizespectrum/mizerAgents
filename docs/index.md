...
- **`AGENTS.md`** — updated to include `@MIZER-AGENTS.md` (created
...
- [mizer](https://sizespectrum.org/mizer/) — the core size-spectrum
  modelling package
- [mizerExamples](https://sizespectrum.org/mizerExamples/) — example
  mizer models
